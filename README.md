...
> **Бесплатные модели:** можно использовать `nvidia/nemotron-3-nano-30b-a3b:free`. Для этого укажите модель в `video_rag/config.py` в параметре `openrouter_model`.
